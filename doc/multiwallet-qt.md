...
Only requiring some minor changes is one.cpp.
...
Changes to one.cpp
----------------------
one.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
