...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "OneNetwork") type = OneNetwork;
    if(strType == "OneNetworkVariable") type = OneNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == OneNetwork) s = "OneNetwork";
    if(type == OneNetworkVariable) s = "OneNetworkVariable";
