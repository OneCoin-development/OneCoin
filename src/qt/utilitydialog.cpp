    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("One Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About One Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  one-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the One in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 ONE, 1 ONE, 10 ONE, and 100 ONE--sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://onepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://onepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("One Core is shutting down...") + "<br /><br />" +
