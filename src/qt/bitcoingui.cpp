    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("One Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a One address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and one: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About One Core"), this);
    aboutAction->setStatusTip(tr("Show information about One Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for One Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your One addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified One addresses"));
    ...
    openAction->setStatusTip(tr("Open a one: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the One Core help message to get a list with possible One Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("One Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to One network", "", count));
}
...
{
    QString strTitle = tr("One Core"); // default title
