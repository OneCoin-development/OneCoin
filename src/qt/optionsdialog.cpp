    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ONE-light"), QVariant("light"));
    ui->theme->addItem(QString("ONE-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ONE-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ONE-traditional"), QVariant("trad"));
